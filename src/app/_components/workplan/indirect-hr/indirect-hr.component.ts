...
@Component({
  selector: 'app-indirect-hr',
  templateUrl: './indirect-hr.component.html',
  styleUrls: ['./indirect-hr.component.scss']
})
export class IndirectHrComponent implements OnInit {
  ...
  resetWorkplan() {
    ...
    this.workplanItem.category = WorkplanCategory.RH_INDIRECT;
