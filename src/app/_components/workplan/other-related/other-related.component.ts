...
@Component({
  selector: 'app-other-related',
  templateUrl: './other-related.component.html',
  styleUrls: ['./other-related.component.scss']
})
export class OtherRelatedComponent implements OnInit {
  ...
  resetWorkplan() {
    ...
    this.workplanItem.category = WorkplanCategory.CORRELATED_OTHER;
