...
@Component({
  selector: 'app-prototype-material',
  templateUrl: './prototype-material.component.html',
  styleUrls: ['./prototype-material.component.scss']
})
export class PrototypeMaterialComponent implements OnInit {
  ...
  resetWorkplan() {
    ...
    this.workplanItem.category = WorkplanCategory.SUPPLIES_PROTOTYPE;
