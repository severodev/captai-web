...
@Component({
  selector: 'app-technological-journals',
  templateUrl: './technological-journals.component.html',
  styleUrls: ['./technological-journals.component.scss']
})
export class TechnologicalJournalsComponent implements OnInit {
  ...
  resetWorkplan() {
    ...
    this.workplanItem.category = WorkplanCategory.BOOKS_JOURNALS;
