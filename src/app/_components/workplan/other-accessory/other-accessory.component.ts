...
@Component({
  selector: 'app-other-accessory',
  templateUrl: './other-accessory.component.html',
  styleUrls: ['./other-accessory.component.scss']
})
export class OtherAccessoryComponent implements OnInit {
  ...
  resetWorkplan() {
    ...
    // this.workplanItem.category = WorkplanCategory.EQUIPMENT_OTHER;
