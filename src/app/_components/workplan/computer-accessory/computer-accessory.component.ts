...
@Component({
  selector: 'app-computer-accessory',
  templateUrl: './computer-accessory.component.html',
  styleUrls: ['./computer-accessory.component.scss']
})
export class ComputerAccessoryComponent implements OnInit {
  ...
  resetWorkplan() {
    ...
    this.workplanItem.category = WorkplanCategory.EQUIPMENT_TECHNOLOGY;
